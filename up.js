...
module.exports = {
    config: {
        name: "up",
        aliases: ["uptime", "upt", "rtm", "status"],
        version: "2.0",
        author: "Mueid Mursalin Rifat", //Don't Remove Author credit 
        countDown: 5,
        role: 0,
        description: {
...
⏱️ Uptime: ${uptime}
🔰  Number of packages: ${dependencyCount >= 0 ? dependencyCount : "Unknown"}
...
🗂️ Free Storage: ${convertToGB(firstDisk.available)}
🤖 Ping: ${pingReal}ms
