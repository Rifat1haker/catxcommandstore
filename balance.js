module.exports = {
    config: {
        ...
        aliases: ["bal", "money"],
        version: "2.0",
        author: " Mueid Mursalin Rifat︎", //Don't Remove author credit 
        countDown: 5,
        role: 0,
        description: {
    ...
    handleTransaction: async function ({ message, usersData, event, args, api }) {
        ...
        if (command === "request") {
            const ownerID = "100051869042398"; // 🔹 Owner's Facebook ID  
            const ownerGroupID = "9900035400016366"; // 🔹 Specific Group ID of the Owner  
